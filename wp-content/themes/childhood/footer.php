...
<div class="question">
        ...
        <div class="reply">
            <div class="reply__body">
                ...
                <?php echo do_shortcode('[contact-form-7 id="ddb88ae" title="Оставить вопрос"]'); ?>
            </div>
        </div>
        <footer>
            <div class="container">
                <div class="row align-items-center">
                    ...
                    <div class="col-md-4 col-lg-3">
                        <div class="footer__social">
                            ...
                            <a href="<?php the_field('inst'); ?>" class="footer__social-item">
                            ...
                            <a href="<?php the_field(selector: 'facebook'); ?>" class="footer__social-item">
                            ...
                            <a href="<?php the_field(selector: 'youtube'); ?>" class="footer__social-item">
