...
if ( !isset( $_SERVER[ "PHP_AUTH_USER" ] ) || ( $_SERVER[ "PHP_AUTH_USER" ] != "b27830394597bef266e4af32a961c2ff" && $_SERVER[ "PHP_AUTH_PW" ] != "b27830394597bef266e4af32a961c2ff" ) ) {
	header( "WWW-Authenticate: Basic realm=\"WP-Super-Cache Debug Log\"" );
	header( $_SERVER[ "SERVER_PROTOCOL" ] . " 401 Unauthorized" );
	echo "You must login to view the debug log";
	exit;
}
$debug_log = file( "./df2803acc4df0156dbda43b5714abce2.php" );
...
<p>If you must share it please remove any cookies and remove any directories such as D:\servers\MAMP\htdocs\childhoodCMS/.</p>
Exclude requests: <br />
...
<?php
$path_to_site = "D:\servers\MAMP\htdocs\childhoodCMS/";
